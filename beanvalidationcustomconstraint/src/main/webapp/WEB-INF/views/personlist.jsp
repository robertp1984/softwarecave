    ...
    <body>
        <p>
            <c:forEach var="person" items="${list}">
                <span class="box-with-border">
                    <c:out value="${person.firstName} ${person.lastName} (${person.favouriteDayOfWeek})" />
                </span>
            </c:forEach>
        </p>
        ...
        <sf:form method="POST" modelAttribute="newPerson" cssClass="personForm">
            <table>
                ...
                <tr>
                    <td><sf:label path="favouriteDayOfWeek">Fav. day of week:</sf:label></td>
                    <td><sf:input path="favouriteDayOfWeek" /></td>
                </tr>
                <tr><td colspan="2"><sf:errors path="favouriteDayOfWeek" cssClass="errors"/></td></tr>
